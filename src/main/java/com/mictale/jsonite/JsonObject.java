...
public final class JsonObject extends JsonValue implements Map<String, JsonValue> {
	...
	protected JsonObject(Map<String, JsonValue> members) {
	...
	public boolean containsValue(Object value) {
		return members.containsValue(JsonValue.of(value));
	}
     ...
     * @param key is the key whose value shal be retrieved.
     * @param defaultValue is the value to return when there is no such key.
     * @return the value associated with the ke or the default value.
     */
	...
	public boolean equals(Object obj) {
		if (obj instanceof JsonObject) {
			...
			return other.size() == size() && members.entrySet().containsAll(other.members.entrySet());
		}
		else {
			return false;
		}
